...
date: 2026-03-26
description: Los riesgos de seguridad de los LLM incluyen la inyección de prompts, la fuga de datos y la manipulación de modelos. Esto es lo que las empresas que despliegan modelos de lenguaje grandes deben comprender y contra lo que deben defenderse.
author: triggerfish
tags:
  - AIage
draft: false
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>El modelo o la aplicación retiene contexto entre sesiones de usuario de forma no intencionada</td>
    ...
    <tr>
      ...
      <td>Monitorización de consultas, limitación de tasa, detección de anomalías</td>
    </tr>
  </tbody>
</table>
...
Revisar cómo los marcos de prueba de[ seguridad de IA](https://trigger.fish/security/) abordan la robustez adversaria ayuda a las organizaciones a construir procesos de evaluación que prueben estos modos de fallo antes del despliegue en lugar de descubrirlos a través de incidentes operativos.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Detección de inyección de prompts, filtrado de contenido, monitorización de entrada</td>
      <td>Manipulación del comportamiento del modelo a través de entradas maliciosas</td>
    </tr>
    <tr>
      <td>Seguridad de salida</td>
      <td>Filtrado de salida, detección de datos confidenciales, monitorización de salida</td>
