...
Organisations that have not mapped their AI data flows in detail cannot satisfy this requirement because they genuinely do not know what they are disclosing. The compliance work and the transparency work are the same work.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Public Task</td>
      <td>Public authorities and organisations with public mandates</td>
...
The direction of travel is clear. GDPR enforcement is moving deeper into AI-specific territory, and the organisations that have treated AI compliance as a future problem are finding it has become a present one.

### **How the EU AI Act Layers on Top of GDPR**

The EU AI Act, which entered into force in 2024, adds a parallel regulatory layer that works alongside GDPR rather than replacing it. Where GDPR governs what happens to personal data, the AI Act governs the characteristics and behaviour of AI systems themselves, particularly those classified as high risk.
...
Understanding how[ AI architecture](https://trigger.fish/architecture/) decisions affect compliance under both frameworks helps organisations design systems that satisfy the full regulatory picture rather than optimising for one regulation at the expense of the other.
...
The three exceptions to Article 22 are contract necessity, explicit consent, and legal authorisation. Each requires specific additional conditions including the right to human review, the right to contest the decision, and the right to obtain an explanation of the logic involved.
...
Article 37 of GDPR requires certain organisations to designate a Data Protection Officer. The requirement applies to public authorities and bodies, organisations whose core activities require large-scale systematic monitoring of individuals, and organisations whose core activities involve large-scale processing of special category data or data relating to criminal convictions.

AI tools frequently trigger this assessment. A retail business that deploys AI for behavioural analytics across millions of customer interactions is engaged in large-scale systematic monitoring. A healthcare organisation using AI to process patient records at scale is processing special category data on a large scale. Both scenarios point toward a mandatory DPO requirement.

Even where the DPO requirement is not strictly mandatory, the function it serves, oversight of data processing activities, liaison with supervisory authorities, and independent compliance advice, is practically essential for organisations running AI systems that touch significant volumes of personal data. Many businesses that are not technically required to appoint a DPO do so because the operational value justifies it.
...
Pseudonymisation reduces risk but does not eliminate GDPR obligations. Data that has been pseudonymised, meaning identifiers have been replaced with codes, is still personal data under GDPR if re-identification is reasonably possible. AI tools processing pseudonymised data are still processing personal data.

Cross-border transfers triggered by AI infrastructure require transfer mechanisms. If your AI vendor processes data on infrastructure outside the EU or EEA, you need a valid transfer mechanism such as Standard Contractual Clauses or a transfer impact assessment. Many cloud AI services route processing through US or Asian data centres by default.
...
**The 30% rule for AI is a practical guideline suggesting that AI automation should cover roughly 30% of a workflow while human judgement and oversight handle the remaining 70%.** In GDPR contexts this framing is particularly useful for Article 22 compliance, helping organisations design AI deployments where humans remain genuinely involved in decisions rather than simply rubber-stamping automated outputs.
