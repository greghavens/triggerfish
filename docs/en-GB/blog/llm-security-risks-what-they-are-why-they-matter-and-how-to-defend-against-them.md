...
<table>
  ...
  <tbody>
    <tr>
      <td>Training data memorisation</td>
...
Reviewing how[ AI security](https://trigger.fish/security/) testing frameworks address adversarial robustness helps organisations build evaluation processes that test for these failure modes before deployment rather than discovering them through operational incidents.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Manipulation of model behaviour through malicious inputs</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Least privilege tool access, source authentication, action authorisation</td>
      <td>Amplified damage from compromised model behaviour</td>
    </tr>
    <tr>
